...
exports.handler = async (event) => {
  try {
    ...
    const { email, fullName, role } = JSON.parse(event.body);
    ...
    return {
      ...
      body: JSON.stringify({
        ...
        tempPassword:
          process.env.ENVIRONMENT === "test" ? tempPassword : undefined, // Only returning password in test environment for testing
      }),
    };
  } catch (error) {
